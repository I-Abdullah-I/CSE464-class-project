...
class LaneLines:
    ...
    def __init__(self):
        ...
        self.dir = []
        self.left_curve_img = mpimg.imread('assets/left_turn.png')
        self.right_curve_img = mpimg.imread('assets/right_turn.png')
        self.keep_straight_img = mpimg.imread('assets/straight.png')
